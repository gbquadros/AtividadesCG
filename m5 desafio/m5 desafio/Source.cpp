...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "M5 desafio", nullptr, nullptr);
	glfwMakeContextCurrent(window);

	// Faz o registro da função de callback para a janela GLFW
	...
	// Compilando e gerando o executavel o programa de shader
	...
	//Carrega uma textura e armazena o identificador na memória	
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Definine as dimensões da viewport com as mesmas dimensões da janela da aplicação
		int width, height;
		glfwGetFramebufferSize(window, &width, &height);
		glViewport(0, 0, width, height);
