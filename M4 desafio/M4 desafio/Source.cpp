...
int main()
{
	...
	// Cria a janela GLFW
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "M4 desafio", nullptr, nullptr);
	glfwMakeContextCurrent(window);

	
	glfwSetKeyCallback(window, key_callback);

	// GLAD: carrega os ponteiros das funções da OpenGL
	...
	// Compila e cria o executavel o programa de shader
	...
	// Associao buffer de textura com o shader
	...
	{
		// Checa se houveram eventos de input (teclado, mouse) e chama as funções de callback
		glfwPollEvents();
